...
use telltale_protocol_machine::determinism::{replay_consistent, DeterminismMode};
use telltale_protocol_machine::effect::{
    EffectFailure, EffectHandler, EffectResult, RecordingEffectHandler, SendDecision,
    SendDecisionInput,
};
use telltale_protocol_machine::OutputConditionPolicy;
use telltale_protocol_machine::ProgressState;
use telltale_protocol_machine::ThreadedProtocolMachine;
use telltale_protocol_machine::{ObsEvent, ProtocolMachine, ProtocolMachineConfig, ProtocolMachineError};
use test_support::{
...
fn run_cooperative(
    images: &[telltale_protocol_machine::loader::CodeImage],
    concurrency: usize,
...
fn run_progress_states(
    image: &telltale_protocol_machine::loader::CodeImage,
) -> (
