...
use telltale_protocol_machine::buffer::{BackpressurePolicy, BoundedBuffer, BufferConfig, BufferMode};
use telltale_protocol_machine::compiler::compile;
use telltale_protocol_machine::coroutine::Value;
use telltale_protocol_machine::instr::{Endpoint, Instr};
use telltale_protocol_machine::loader::CodeImage;
use telltale_protocol_machine::session::{unfold_if_var, unfold_mu};
...
fn prop_block_preserves_pc() {
    ...
    if matches!(coro.status, telltale_protocol_machine::CoroStatus::Blocked(_)) {
