...
use telltale_protocol_machine::{Instr, ProtocolMachine, ProtocolMachineConfig};
use telltale_protocol_machine::{ProtocolMachineError, ProtocolMachineRunStatus};

cfg_if! {
    if #[cfg(feature = "multi-thread")] {
        use telltale_protocol_machine::ThreadedGuestRuntime;
    }
}
...
impl EffectHandler for NoopHandler {
    fn handle_send(
        ...
        EffectResult::success(telltale_protocol_machine::Value::Unit)
    }
