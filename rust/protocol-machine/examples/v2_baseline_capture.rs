...
cfg_if! {
    ...
    use telltale_protocol_machine::determinism::{DeterminismMode, EffectDeterminismTier};
    ...
    use telltale_protocol_machine::envelope_diff::EnvelopeDiffArtifactV1;
    use telltale_protocol_machine::loader::CodeImage;
    use telltale_protocol_machine::{RuntimeTuningProfile, ProtocolMachineStepResult as ProtocolMachineStepResult};
    use telltale_protocol_machine::verification::{DefaultVerificationModel, HashTag, VerificationModel};
    use telltale_protocol_machine::{ProtocolMachine, ProtocolMachineConfig, ThreadedGuestRuntime};
    ...
    impl EffectHandler for PassthroughHandler {
        ...
        fn handle_send(
            ...
            _label: &str,
            _state: &[Value],
        ) -> telltale_protocol_machine::effect::EffectResult<Value> {
            telltale_protocol_machine::effect::EffectResult::success(Value::Nat(1))
        }
        ...
        fn handle_recv(
            ...
            _payload: &Value,
        ) -> telltale_protocol_machine::effect::EffectResult<()> {
            telltale_protocol_machine::effect::EffectResult::success(())
        }
        ...
        fn handle_choose(
            ...
            labels: &[String],
            _state: &[Value],
        ) -> telltale_protocol_machine::effect::EffectResult<String> {
            match labels.first().cloned() {
                Some(label) => telltale_protocol_machine::effect::EffectResult::success(label),
                None => telltale_protocol_machine::effect::EffectResult::failure(
