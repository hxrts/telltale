...
use telltale_runtime::effects::{interpret, Program};
...
impl telltale_runtime::LabelId for BenchLabel {
...
impl telltale_runtime::RoleId for BenchRole {
    type Label = BenchLabel;

    fn role_name(&self) -> telltale_runtime::RoleName {
        match self {
            Self::Alice => telltale_runtime::RoleName::from_static("Alice"),
            Self::Bob => telltale_runtime::RoleName::from_static("Bob"),
        }
    }
}
