...
axiom end_cannot_consume (sender receiver : String) (label : Label) :
    GlobalType.end.consume sender receiver label = none
...
axiom terminated_config_queues_empty_full (g : GlobalType) (c : Configuration)
