...
All of these are PROVEN without proof gaps in LocalTypeDB.lean!
-/

namespace SessionTypes.LocalTypeDBExamples
...
named variables via the bridge theorems (which have minimal bridge gaps
...
end SessionTypes.LocalTypeDBExamples
