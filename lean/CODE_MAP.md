...
|----------------|------:|--------:|------------------------------------------------------------|
| SessionTypes   |    47 |   9,919 | Global/local type definitions, de Bruijn, participation    |
| SessionCoTypes |    78 |  16,305 | Coinductive EQ2, bisimulation, duality, async subtyping    |
| Choreography   |    89 |  19,304 | Projection, harmony, blindness, embedding, erasure         |
...
| Runtime        |   145 |  28,233 | VM, Iris backend via iris-lean, resource algebras, WP      |
