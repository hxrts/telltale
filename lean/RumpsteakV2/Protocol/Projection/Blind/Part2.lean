import RumpsteakV2.Protocol.Projection.Blind.Part1

/-! # RumpsteakV2.Protocol.Projection.Blind.Part2

Step-preservation helper lemmas for blindness.
-/

namespace RumpsteakV2.Protocol.Projection.Blind
...
private theorem isBlindBranches_substitute_aux (bs : List (Label × GlobalType))
    ...
    isBlindBranches (GlobalType.substituteBranches bs t repl) = true := by
  match bs with
  | [] => simp [GlobalType.substituteBranches, isBlindBranches]
  | (label, cont) :: rest =>
      simp only [GlobalType.substituteBranches, isBlindBranches, Bool.and_eq_true]
...
theorem isBlind_substitute (g : GlobalType) (t : String) (repl : GlobalType)
  ...
  | .comm sender receiver branches =>
      ...
      · -- commBlindFor preserved: uniformity is preserved under uniform substitution
        ...
        cases hbranches : GlobalType.substituteBranches branches t repl with
        | nil => simp
        | cons head' rest' =>
            ...
            | cons head rest =>
                ...
                | mk label cont =>
                    ...
                    | mk label' cont' =>
                        ...
                        induction rest with
                        | nil => simp [GlobalType.substituteBranches]
                        | cons rhd rtl ih_rest =>
                            simp only [GlobalType.substituteBranches, List.all, Bool.and_eq_true]
...
end RumpsteakV2.Protocol.Projection.Blind
