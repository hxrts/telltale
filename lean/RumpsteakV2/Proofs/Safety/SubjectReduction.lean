...
/-- Claims bundle for subject reduction (TODO: fill with formal statements). -/
structure Claims where
  /-- Subject reduction preserves typing. -/
  subject_reduction : Prop

/-! ## Proofs -/

-- TODO: implement subject reduction and build the `claims` bundle.
