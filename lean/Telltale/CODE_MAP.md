# CODE_MAP.md — Telltale Lean Verification
...
Telltale formally verifies choreographic projection and session-type safety properties in Lean 4. The development covers:
