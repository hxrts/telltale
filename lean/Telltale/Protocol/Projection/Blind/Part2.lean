import Telltale.Protocol.Projection.Blind.Part1

/-! # Telltale.Protocol.Projection.Blind.Part2

Step-preservation helper lemmas for blindness.
-/

namespace Telltale.Protocol.Projection.Blind
...
end Telltale.Protocol.Projection.Blind
