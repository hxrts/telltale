import Telltale.Protocol.Projection.Project.ImplBase
...
private theorem EQ2_fullUnfold_end {e : LocalTypeR} (hWF : LocalTypeR.WellFormed e) :
  ...
  intro heq
  have hobs := Telltale.Protocol.CoTypes.Bisim.EQ2_transfer_observable heq
    (Telltale.Protocol.CoTypes.Observable.Observable.is_end
      Telltale.Protocol.CoTypes.Observable.UnfoldsToEnd.base) hWF
  rcases hobs with ⟨_, hrel⟩
  cases hrel with
  | is_end =>
      rename_i ha hb
      exact Telltale.Protocol.CoTypes.Bisim.UnfoldsToEnd.fullUnfold_eq hb hWF
  | is_var =>
      rename_i v ha hb
      have hcontra : False :=
        (Telltale.Protocol.CoTypes.Observable.UnfoldsToEnd.not_var_of_end
          (a := .end) (Telltale.Protocol.CoTypes.Observable.UnfoldsToEnd.base)) v ha
      cases hcontra
  | is_send hbr =>
      rename_i p bs cs ha hb
      have hcontra : False :=
        (Telltale.Protocol.CoTypes.Observable.CanSend.not_end (a := .end) (p := p) (bs := bs) ha)
          (Telltale.Protocol.CoTypes.Observable.UnfoldsToEnd.base)
      cases hcontra
  | is_recv hbr =>
      rename_i p bs cs ha hb
      have hcontra : False :=
        (Telltale.Protocol.CoTypes.Observable.CanRecv.not_end (a := .end) (p := p) (bs := bs) ha)
          (Telltale.Protocol.CoTypes.Observable.UnfoldsToEnd.base)
      cases hcontra
...
private theorem EQ2_fullUnfold_var {t : String} {e : LocalTypeR} (hWF : LocalTypeR.WellFormed e) :
  ...
  intro heq
  have hobs := Telltale.Protocol.CoTypes.Bisim.EQ2_transfer_observable heq
    (Telltale.Protocol.CoTypes.Observable.Observable.is_var
      (Telltale.Protocol.CoTypes.Observable.UnfoldsToVar.base (v := t))) hWF
  rcases hobs with ⟨_, hrel⟩
  cases hrel with
  | is_var =>
      rename_i v ha hb
      have hv := Telltale.Protocol.CoTypes.Observable.UnfoldsToVar.deterministic ha
        (Telltale.Protocol.CoTypes.Observable.UnfoldsToVar.base (v := t))
      subst hv
      exact Telltale.Protocol.CoTypes.Bisim.UnfoldsToVar.fullUnfold_eq hb hWF
  | is_end =>
      rename_i ha hb
      cases (Telltale.Protocol.CoTypes.Observable.UnfoldsToEnd.not_var (v := t)) ha
  | is_send hbr =>
      rename_i p bs cs ha hb
      cases
        (Telltale.Protocol.CoTypes.Observable.CanSend.not_var
          (a := .var t) (p := p) (bs := bs) ha) t
          (Telltale.Protocol.CoTypes.Observable.UnfoldsToVar.base (v := t))
  | is_recv hbr =>
      rename_i p bs cs ha hb
      cases
        (Telltale.Protocol.CoTypes.Observable.CanRecv.not_var
          (a := .var t) (p := p) (bs := bs) ha) t
          (Telltale.Protocol.CoTypes.Observable.UnfoldsToVar.base (v := t))
...
theorem EQ2_fullUnfold_send {p : String} {bs : List (Label × LocalTypeR)}
  ...
  have hobs := Telltale.Protocol.CoTypes.Bisim.EQ2_transfer_observable heq
    (Telltale.Protocol.CoTypes.Observable.Observable.is_send
      (Telltale.Protocol.CoTypes.Observable.CanSend.base (partner := p) (branches := bs))) hWF
  rcases hobs with ⟨_, hrel⟩
  cases hrel with
  | is_send hbr =>
      rename_i p' bs' cs' ha hb
      have ⟨hp, hbs⟩ := Telltale.Protocol.CoTypes.Observable.CanSend.deterministic ha
        (Telltale.Protocol.CoTypes.Observable.CanSend.base (partner := p) (branches := bs))
      subst hp hbs
      exact ⟨_, Telltale.Protocol.CoTypes.Bisim.CanSend.fullUnfold_eq hb hWF, hbr⟩
  | is_end =>
      rename_i ha hb
      cases (Telltale.Protocol.CoTypes.Observable.UnfoldsToEnd.not_send (p := p) (bs := bs)) ha
  | is_var =>
      rename_i v ha hb
      cases
        (Telltale.Protocol.CoTypes.Observable.CanSend.not_var
          (a := .send p bs) (p := p) (bs := bs)
          (Telltale.Protocol.CoTypes.Observable.CanSend.base (partner := p) (branches := bs))) v ha
  | is_recv hbr =>
      rename_i p' bs' cs' ha hb
      cases
        (Telltale.Protocol.CoTypes.Observable.CanSend.not_recv
          (a := .send p bs) (p := p) (q := p') (bs := bs) (cs := bs')
          (Telltale.Protocol.CoTypes.Observable.CanSend.base (partner := p) (branches := bs))) ha
...
theorem EQ2_fullUnfold_recv {p : String} {bs : List (Label × LocalTypeR)}
  ...
  intro heq -- Transfer observables through EQ2 and eliminate impossible cases.
  have hobs := Telltale.Protocol.CoTypes.Bisim.EQ2_transfer_observable heq
    (Telltale.Protocol.CoTypes.Observable.Observable.is_recv
      (Telltale.Protocol.CoTypes.Observable.CanRecv.base (partner := p) (branches := bs))) hWF
  rcases hobs with ⟨_, hrel⟩; cases hrel with
  | is_recv hbr =>
      rename_i p' bs' cs' ha hb
      have ⟨hp, hbs⟩ := Telltale.Protocol.CoTypes.Observable.CanRecv.deterministic ha
        (Telltale.Protocol.CoTypes.Observable.CanRecv.base (partner := p) (branches := bs))
      subst hp hbs
      exact ⟨_, Telltale.Protocol.CoTypes.Bisim.CanRecv.fullUnfold_eq hb hWF, hbr⟩
  | is_end =>
      rename_i ha hb
      cases (Telltale.Protocol.CoTypes.Observable.UnfoldsToEnd.not_recv (p := p) (bs := bs)) ha
  | is_var =>
      rename_i v ha hb
      cases
        (Telltale.Protocol.CoTypes.Observable.CanRecv.not_var
          (a := .recv p bs) (p := p) (bs := bs)
          (Telltale.Protocol.CoTypes.Observable.CanRecv.base (partner := p) (branches := bs))) v ha
  | is_send hbr =>
      rename_i p' bs' cs' ha hb
      cases
        (Telltale.Protocol.CoTypes.Observable.CanSend.not_recv
