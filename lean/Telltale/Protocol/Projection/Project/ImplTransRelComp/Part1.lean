import Telltale.Protocol.Projection.Project.ImplConstructors
...
theorem CProject_wellFormed_of_wellFormed {g : GlobalType} {role : String} {lt : LocalTypeR}
  ...
  have hWFtrans : LocalTypeR.WellFormed (Trans.trans g role) :=
    Telltale.Protocol.Projection.Trans.trans_wellFormed_of_wellFormed g role hwf
...
/-- Well-formed variant of CProjectTransRelComp (tracks WellFormed endpoints). -/
