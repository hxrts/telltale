import Telltale.Protocol.Projection.Projectb.Part1

namespace Telltale.Protocol.Projection.Projectb
...
theorem CProject_gfp : CProject = Telltale.Protocol.CoTypes.CoinductiveRel.gfp (F := CProjectF) := rfl

/-- Alias: CProjectU as gfp via CoinductiveRel. -/
theorem CProjectU_gfp : CProjectU = Telltale.Protocol.CoTypes.CoinductiveRel.gfp (F := CProjectF_unfold) := rfl

/-- Alias: coinduction via CoinductiveRel for CProject. -/
theorem CProject_coind' {R : ProjRel} (h : R ≤ CProjectF R) : R ≤ CProject := by
  simpa [CProject] using (Telltale.Protocol.CoTypes.CoinductiveRel.coind (F := CProjectF) h)
...
theorem CProjectU_coind' {R : ProjRel} (h : R ≤ CProjectF_unfold R) : R ≤ CProjectU := by
  simpa [CProjectU] using (Telltale.Protocol.CoTypes.CoinductiveRel.coind (F := CProjectF_unfold) h)
...
theorem CProject_unfold' : CProject ≤ CProjectF CProject := by
  ...
  exact Telltale.Protocol.CoTypes.CoinductiveRel.unfold (F := CProjectF)
...
theorem CProject_fold' : CProjectF CProject ≤ CProject := by
  change CProjectF (OrderHom.gfp ⟨CProjectF, CProjectF_mono⟩) ≤
    OrderHom.gfp ⟨CProjectF, CProjectF_mono⟩
  exact Telltale.Protocol.CoTypes.CoinductiveRel.fold (F := CProjectF)
...
theorem CProjectU_unfold' : CProjectU ≤ CProjectF_unfold CProjectU := by
  ...
  exact Telltale.Protocol.CoTypes.CoinductiveRel.unfold (F := CProjectF_unfold)
...
theorem CProjectU_fold' : CProjectF_unfold CProjectU ≤ CProjectU := by
  change CProjectF_unfold (OrderHom.gfp ⟨CProjectF_unfold, CProjectF_unfold_mono⟩) ≤
    OrderHom.gfp ⟨CProjectF_unfold, CProjectF_unfold_mono⟩
  exact Telltale.Protocol.CoTypes.CoinductiveRel.fold (F := CProjectF_unfold)

private theorem CProject_fixed : CProjectF CProject = CProject := by
  change CProjectF (OrderHom.gfp ⟨CProjectF, CProjectF_mono⟩) =
    OrderHom.gfp ⟨CProjectF, CProjectF_mono⟩
  exact Telltale.Protocol.CoTypes.CoinductiveRel.gfp_fixed (F := CProjectF)

private theorem CProjectU_fixed : CProjectF_unfold CProjectU = CProjectU := by
  change CProjectF_unfold (OrderHom.gfp ⟨CProjectF_unfold, CProjectF_unfold_mono⟩) =
    OrderHom.gfp ⟨CProjectF_unfold, CProjectF_unfold_mono⟩
  exact Telltale.Protocol.CoTypes.CoinductiveRel.gfp_fixed (F := CProjectF_unfold)
...
end Telltale.Protocol.Projection.Projectb
