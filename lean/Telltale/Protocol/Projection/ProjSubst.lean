...
namespace Telltale.Protocol.Projection.ProjSubst

open Telltale.Protocol.GlobalType (GlobalType Label)
open Telltale.Protocol.LocalTypeR (LocalTypeR)
open Telltale.Protocol.CoTypes.EQ2 (EQ2 EQ2_refl)
            ...
            | cons head tail =>
                ...
                | mk label cont =>
                    ...
                    simp [GlobalType.substitute, GlobalType.substituteBranches, projTrans,
                      ...
                      Protocol.Projection.Trans.trans_comm_other sender receiver role ((label, cont) :: tail) hs hr,
                      hrec]
...
end Telltale.Protocol.Projection.ProjSubst
