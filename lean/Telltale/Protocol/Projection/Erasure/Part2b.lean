import Telltale.Protocol.Projection.Erasure.Part2a

/-! # Telltale.Protocol.Projection.Erasure.Part2b

Merge soundness helpers and proofs for erasure.
-/
namespace Telltale.Protocol.Projection.Erasure
...
end Telltale.Protocol.Projection.Erasure
