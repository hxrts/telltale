...
namespace Telltale.Protocol.CoTypes.FullUnfold
...
is defined in `Telltale.Protocol.Projection.Trans`. The key theorem to prove
would be that fullUnfold commutes with projection in the appropriate sense. -/

end Telltale.Protocol.CoTypes.FullUnfold
