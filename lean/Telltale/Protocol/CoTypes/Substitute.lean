...
open Telltale.Protocol.CoTypes.SubstCommBarendregt
...
namespace Telltale.Protocol.CoTypes.Substitute
...
theorem EQ2_substitute (a b : LocalTypeR) (var : String) (repl : LocalTypeR) :
  ...
  Telltale.Protocol.CoTypes.Bisim.EQ2_substitute_via_Bisim (a := a) (b := b) (var := var) (repl := repl)
...
theorem unfold_substitute_EQ2 (t : LocalTypeR) (var : String) (repl : LocalTypeR)
    ...
    EQ2 ((t.substitute var repl).unfold) ((t.unfold).substitute var repl) :=
  Telltale.Protocol.CoTypes.Bisim.unfold_substitute_EQ2_via_Bisim t var repl hWFt hWFrepl
...
end Telltale.Protocol.CoTypes.Substitute
