  ...
  | inl hSubst =>
    ...
    | mu x body =>
      ...
      · -- x = var: substitution is shadowed
        ...
        have hnotfree : Telltale.Protocol.CoTypes.SubstCommBarendregt.isFreeIn x
        ...
        have hv_eq_u : (body.substitute x (.mu x body)).substitute var repl =
          ...
          exact Telltale.Protocol.CoTypes.SubstCommBarendregt.substitute_not_free _ x repl hnotfree
        rw [hv_eq_u]
