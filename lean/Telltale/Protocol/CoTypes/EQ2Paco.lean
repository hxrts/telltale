...
import Telltale.Protocol.CoTypes.CoinductiveRelPaco
...
namespace Telltale.Protocol.CoTypes.EQ2Paco

open Telltale.Protocol.CoTypes.EQ2
open Telltale.Protocol.CoTypes.Bisim
...
theorem EQ2_paco_coind (R : EQ2.Rel) (r : EQ2.Rel)
  ...
  apply Telltale.Protocol.CoTypes.CoinductiveRelPaco.coind_upto_pointwise EQ2FMono (toPacoRel R) (toPacoRel r)
  · intro a b hab
...
theorem EQ2_paco_coind_acc (R : EQ2.Rel) (r : EQ2.Rel)
    ...
    {x y : LocalTypeR} (hxy : R x y) :
    paco EQ2FMono (toPacoRel r) x y := by
  apply Telltale.Protocol.CoTypes.CoinductiveRelPaco.coind_upto_acc EQ2FMono (toPacoRel R) (toPacoRel r)
  · intro a b hab
    -- hab : toPacoRel R a b = R a b
...
theorem EQ2_gpaco_coind (R r g : EQ2.Rel)
  ...
  apply Telltale.Protocol.CoTypes.CoinductiveRelPaco.gcoind_upto_pointwise
...
theorem EQ2_gpaco_coind' (R r g : EQ2.Rel)
  ...
  intro x y hxy
  apply Telltale.Protocol.CoTypes.CoinductiveRelPaco.gcoind_upto
    EQ2FMono (toPacoRel R) (toPacoRel r) (toPacoRel g)
  · intro a b hab
    exact hpost a b hab
  · exact hxy
...
end Telltale.Protocol.CoTypes.EQ2Paco
