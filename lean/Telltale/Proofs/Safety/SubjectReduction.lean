...
import Telltale.Proofs.Projection.Harmony
...
/-! # Telltale.Proofs.Safety.SubjectReduction
...
namespace Telltale.Proofs.Safety.SubjectReduction
...
open Telltale.Semantics.Typing
open Telltale.Proofs.Projection.Harmony
...
def Configuration.canStep (c : Configuration) (act : GlobalActionR) : Prop :=
  ...
  Telltale.Protocol.GlobalType.canStep c.globalType act
...
theorem other_type_preserved (g g' : GlobalType) (act : GlobalActionR) (role : String)
    ...
    (hblind : Telltale.Protocol.Projection.Blind.isBlind g = true)
...
end Telltale.Proofs.Safety.SubjectReduction
