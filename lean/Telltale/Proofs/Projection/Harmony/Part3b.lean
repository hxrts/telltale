import Telltale.Proofs.Projection.Harmony.Part3
import Telltale.Protocol.Projection.Blind
...
open Telltale.Protocol.Projection.Trans (trans_wellFormed_of_wellFormed)
open Telltale.Protocol.Projection.Blind (isBlind isBlind_mu_body isBlind_substitute)
...
theorem proj_trans_other_step_branches_nil (act : GlobalActionR) (role : String)
  ...
  simp [projTransBranches, Telltale.Protocol.Projection.Trans.transBranches, BranchesRel]
