...
import Telltale.Proofs.Safety.Determinism
import Telltale.Proofs.Projection.MuUnfoldLemmas
...
/-! # Telltale.Proofs.Projection.Harmony
...
open Telltale.Protocol.Participation (part_of2 part_of_all2 part_of_all2_comm_inv not_part_of2_comm)
open Telltale.Protocol.CoTypes.EQ2
open Telltale.Protocol.CoTypes.EQ2Props
open Telltale.Protocol.CoTypes.Quotient
open Telltale.Semantics.EnvStep

-- Alias to avoid ambiguity with Trans typeclass
abbrev projTrans := Telltale.Protocol.Projection.Trans.trans
