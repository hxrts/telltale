...
namespace Telltale.Proofs.Projection.SubstEndUnguarded

open Telltale.Protocol.LocalTypeR (LocalTypeR substituteBranches substitute_send substitute_recv substitute_end)
open Telltale.Protocol.GlobalType (Label)
open Telltale.Protocol.CoTypes.EQ2
open Telltale.Protocol.CoTypes.Observable
open Telltale.Protocol.CoTypes.Bisim (UnfoldsToEnd.toEQ2)

-- Use the isFreeIn from SubstCommBarendregt
open Telltale.Protocol.CoTypes.SubstCommBarendregt (isFreeIn isFreeInBranches substitute_not_free)
...
end Telltale.Proofs.Projection.SubstEndUnguarded
