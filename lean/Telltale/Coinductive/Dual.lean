...
private theorem dest_dualC_send (p : String) (labels : List Telltale.Protocol.GlobalType.Label)
...
private theorem dest_dualC_recv (p : String) (labels : List Telltale.Protocol.GlobalType.Label)
...
private theorem dest_dualC_twice_send (p : String) (labels : List Telltale.Protocol.GlobalType.Label)
    (f : LocalTypeF.B (.send p labels) → LocalTypeC) :
...
private theorem dest_dualC_twice_recv (p : String) (labels : List Telltale.Protocol.GlobalType.Label)
    (f : LocalTypeF.B (.recv p labels) → LocalTypeC) :
