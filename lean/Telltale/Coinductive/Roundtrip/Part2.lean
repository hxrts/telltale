import Telltale.Coinductive.Roundtrip.Part1
import Telltale.Coinductive.Roundtrip.GpacoCollapse
...
theorem EQ2CE_to_EQ2C'_toCoind {ρ : EnvPair}
    {a b : Telltale.Protocol.LocalTypeR.LocalTypeR}
...
theorem EQ2CE_resolved_to_EQ2C_toCoind
    {ρ : EnvPair} {a b : Telltale.Protocol.LocalTypeR.LocalTypeR}
...
theorem EQ2CE_to_EQ2C_projTrans {ρ : EnvPair}
    {g₁ g₂ : Telltale.Protocol.GlobalType.GlobalType}
    {role₁ role₂ : String}
    (hce : EQ2CE ρ
      (toCoind (Telltale.Protocol.Projection.Trans.trans g₁ role₁))
      (toCoind (Telltale.Protocol.Projection.Trans.trans g₂ role₂)))
    (hEnvL : EnvResolvesL ρ) (hVarR : EnvVarR ρ) :
    EQ2C (toCoind (Telltale.Protocol.Projection.Trans.trans g₁ role₁))
         (toCoind (Telltale.Protocol.Projection.Trans.trans g₂ role₂)) := by
  -- Projection outputs are inductive, so toCoind images are productive.
  have hprod₁ :
      ProductiveC (toCoind (Telltale.Protocol.Projection.Trans.trans g₁ role₁)) :=
...
theorem EQ2CE_resolved_to_EQ2C_projTrans
    {ρ : EnvPair} {g₁ g₂ : Telltale.Protocol.GlobalType.GlobalType}
    {role₁ role₂ : String}
    (h : EQ2CE_resolved ρ
      (toCoind (Telltale.Protocol.Projection.Trans.trans g₁ role₁))
      (toCoind (Telltale.Protocol.Projection.Trans.trans g₂ role₂))) :
...
theorem EQ2CE_to_EQ2C_paco_projTrans
    ...
    (hR : EQ2CE_rel_paco
      (toCoind (Telltale.Protocol.Projection.Trans.trans g₁ role₁))
      (toCoind (Telltale.Protocol.Projection.Trans.trans g₂ role₂))) :
    EQ2C_paco (toCoind (Telltale.Protocol.Projection.Trans.trans g₁ role₁))
              (toCoind (Telltale.Protocol.Projection.Trans.trans g₂ role₂)) :=
