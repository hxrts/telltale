...
lemma observable_mkSend (p : String) (bs : List (Telltale.Protocol.GlobalType.Label × LocalTypeC)) :
...
lemma observable_mkRecv (p : String) (bs : List (Telltale.Protocol.GlobalType.Label × LocalTypeC)) :
