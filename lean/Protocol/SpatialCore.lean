...
/-! # MPST Spatial Type System (Core)

Core spatial requirements, topology semantics, and subtyping soundness.
-/

/-
The Problem. Protocols need static spatial constraints and a semantic satisfaction relation.

Solution Structure. Define requirement/topology/satisfaction/subtyping, then prove monotonicity.
-/
