...
Buffer-typing preservation helpers plus recv/branch valid-label preservation and init lemmas.
-/

/-
The Problem. Extend ValidLabels preservation to recv/branch updates and initialization settings.
