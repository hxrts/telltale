import Runtime.ProtocolMachine.Runtime.Failure.Transitions

/-! # Runtime.Proofs.ProtocolMachine.FailurePredicates
...
predicates, participation predicates, and crash/close safety predicates. This
module is proof-only and intentionally outside `Runtime.ProtocolMachine`.
-/
