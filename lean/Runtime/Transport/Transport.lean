...
def IsHandlerTrace {ν : Type u} [VerificationModel ν]
    (_handler : HandlerId) (_trace : TransportTrace ν) : Prop :=
  -- Handler-level traces are generated by the handler protocol.
  True
...
def transport_refines_buffers {ν : Type u} [VerificationModel ν]
    (_t : Transport ν) (spec : TransportSpec ν) : Prop :=
  -- Transport traces satisfy their declared specification.
  ∀ trace, SpecSatisfied spec trace
