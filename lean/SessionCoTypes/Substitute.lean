...
open SessionCoTypes.SubstCommBarendregt
...
namespace SessionCoTypes.Substitute
...
theorem EQ2_substitute (a b : LocalTypeR) (var : String) (repl : LocalTypeR) :
  ...
  SessionCoTypes.Bisim.EQ2_substitute_via_Bisim (a := a) (b := b) (var := var) (repl := repl)
