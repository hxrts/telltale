...
| protocol machine envelope adherence family | `ProtocolMachineEnvelopeAdherenceProfile` | `protocol_machine_envelope_adherence` |
| protocol machine envelope admission family | `ProtocolMachineEnvelopeAdmissionProfile` | `protocol_machine_envelope_admission` |
