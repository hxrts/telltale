...
| Property buckets with executable assurance suites | 12 | Curated property-suite map in `scripts/check/verification-inventory.sh` |
...
| Explicit unsupported or fail-closed property notes | 4 | Curated unsupported-surface note list in `scripts/check/verification-inventory.sh` |
