...
See [Choreographic DSL](04_choreographic_dsl.md) for role declarations and [Choreography Effect Handlers](08_effect_handlers.md) for choreography handler usage patterns.
