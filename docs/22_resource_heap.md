...
See [Content Addressing](21_content_addressing.md) for the type level content ID system and [Effect Handlers](07_effect_handlers.md) for runtime integration.
