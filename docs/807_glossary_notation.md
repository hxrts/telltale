...
| effect handler | Host-runtime boundary trait (`EffectHandler`) implemented by embedders and simulators. | [Effect Handlers and Session Types](11_effect_session_bridge.md), [API Reference](30_api_reference.md) |
