...
- [VM Simulation Runner](14_vm_simulation_runner.md): trace shape, runner entry points, harness APIs, sampling model, and round order.
- [VM Simulation Scenarios](14_vm_simulation_scenarios.md): scenario schema, TOML examples, fault and network middleware, properties, checkpointing, and replay.
- [VM Simulation Materials](14_vm_simulation_materials.md): material handlers, distributed simulation, post-run analysis, conformance lanes, and current limits.
