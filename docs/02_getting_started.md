...
telltale = { version = "1.1.0", default-features = false }
```
...
```toml
# Everything enabled
telltale = { version = "1.1.0", features = ["full"] }
```
...
```toml
telltale-choreography = { version = "1.1.0", features = ["wasm"] }
```
