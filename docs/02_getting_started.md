...
telltale = { version = "5.0.0", default-features = false }
```
...
```toml
# Everything enabled
telltale = { version = "5.0.0", features = ["full"] }
```
...
```toml
telltale-choreography = { version = "5.0.0", features = ["wasm"] }
```
