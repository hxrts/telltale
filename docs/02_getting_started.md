...
telltale = { version = "4.0.0", default-features = false }
```
...
```toml
# Everything enabled
telltale = { version = "4.0.0", features = ["full"] }
```
...
```toml
telltale-choreography = { version = "4.0.0", features = ["wasm"] }
```
