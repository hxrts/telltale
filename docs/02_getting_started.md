...
telltale = { version = "4.0.1", default-features = false }
```
...
```toml
# Everything enabled
telltale = { version = "4.0.1", features = ["full"] }
```
...
```toml
telltale-choreography = { version = "4.0.1", features = ["wasm"] }
```
