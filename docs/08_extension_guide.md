...
You need Rust 1.75 or later. Basic understanding of choreographic programming is required. See [Getting Started](01_getting_started.md) for fundamentals. Familiarity with effect handlers helps. See [Using Rumpsteak Handlers](06_rumpsteak_handler.md) for handler concepts.
...
Learn extension architecture in [Extension Architecture](07_extension_architecture.md). Explore advanced examples in `choreography/examples/`. Read about testing in the examples directory. See production handlers in [Using Rumpsteak Handlers](06_rumpsteak_handler.md).
