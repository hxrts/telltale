...
tell! {
    ...
    protocol FFT =
      ...
      P0 -> P1 : Value(crate::Complex32,)
      P1 -> P0 : Value(crate::Complex32,)
      P2 -> P3 : Value(crate::Complex32,)
      P3 -> P2 : Value(crate::Complex32,)
      P4 -> P5 : Value(crate::Complex32,)
      P5 -> P4 : Value(crate::Complex32,)
      P6 -> P7 : Value(crate::Complex32,)
      P7 -> P6 : Value(crate::Complex32,)
      -- // Stage 2 exchanges values at stride two.
      P0 -> P2 : Value(crate::Complex32,)
      P2 -> P0 : Value(crate::Complex32,)
      P1 -> P3 : Value(crate::Complex32,)
      P3 -> P1 : Value(crate::Complex32,)
      P4 -> P6 : Value(crate::Complex32,)
      P6 -> P4 : Value(crate::Complex32,)
      P5 -> P7 : Value(crate::Complex32,)
      P7 -> P5 : Value(crate::Complex32,)
      -- // Stage 3 exchanges values at stride four to complete the FFT network.
      P0 -> P4 : Value(crate::Complex32,)
      P4 -> P0 : Value(crate::Complex32,)
      P1 -> P5 : Value(crate::Complex32,)
      P5 -> P1 : Value(crate::Complex32,)
      P2 -> P6 : Value(crate::Complex32,)
      P6 -> P2 : Value(crate::Complex32,)
      P3 -> P7 : Value(crate::Complex32,)
      P7 -> P3 : Value(crate::Complex32,)
}
