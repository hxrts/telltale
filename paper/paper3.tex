...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{L{0.29\textwidth}L{0.37\textwidth}L{0.06\textwidth}>{\raggedright\arraybackslash}X}
		...
		\rowcolor{gray!8}
		\texttt{safe\_delegation\_\allowbreak iff\_footprint} & \texttt{Protocol/\allowbreak Coherence/\allowbreak}\mbox{\texttt{ErasureCharacterization.lean}} & \S\ref{sec:theorem-c} & Thm.~\ref{thm:delegation} \\
