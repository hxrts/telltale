...
objects with total checkers. In that regime, the combined check is polynomial in
the explored finite object size up to witness-check overhead.
...
\begin{table}[H]
	...
	\begin{tabularx}{\columnwidth}{@{}L{0.53\columnwidth}L{0.42\columnwidth}@{}}
		...
		Fairness-dependent claims & Theorem~\ref{thm:conservation} transition-side bounded-dissipation clause uses declared scheduler-profile premises \\
		\bottomrule
	\end{tabularx}
