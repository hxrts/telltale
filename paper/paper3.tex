...
\begin{table}[H]
	...
	\begin{tabularx}{\columnwidth}{@{}L{0.47\columnwidth}L{0.48\columnwidth}@{}}
		...
		\midrule
		\texttt{link\_harmony\_through\_link} & \texttt{Protocol/Deployment/\allowbreak}\mbox{\texttt{LinkingCore.lean}} \\
		...
		\texttt{consensusEnvelope\_exact\_of\_profile} & \texttt{Runtime/Adequacy/\allowbreak EnvelopeCore/}\mbox{\texttt{*.lean}} \\
		\texttt{vm\_adequacy\_of\_trace\_consistency} & \texttt{Runtime/Adequacy/}\mbox{\texttt{Adequacy.lean}} \\
		\texttt{byzantineSafety\_exact\_of\_profile} & \texttt{Runtime/Proofs/Adapters/\allowbreak Distributed/}\mbox{\texttt{EnvelopeTheorems.lean}} \\
		\texttt{canOperateUnderByzantineEnvelope} & \texttt{Runtime/Proofs/TheoremPack/}\mbox{\texttt{*.lean}} \\
		\texttt{effectBisim\_congruence} & \texttt{Runtime/Proofs/EffectBisim/\allowbreak}\mbox{\texttt{Congruence.lean}} \\
		\texttt{lyapunov\_descent} & \texttt{Runtime/Proofs/}\mbox{\texttt{Lyapunov.lean}} \\
		\bottomrule
	\end{tabularx}
