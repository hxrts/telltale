...
\begin{equation}
	\dfrac{
		\Bc=2;\ \Phase\ \text{as in Theorem C.3}
	}{
		\begin{aligned}
			\Phase(1) & =\mathsf{Low}      \\
...
Path identifiers in this section resolve in Appendix~\ref{app:p2-path-registry}.

\begin{table}[H]
	\centering
	\footnotesize
	\begin{tabularx}{\columnwidth}{@{}L{0.19\columnwidth}L{0.39\columnwidth}L{0.32\columnwidth}@{}}
		\toprule
		\thead{Layer} & \thead{Modules}                               & \thead{Anchors}                                          \\
		\midrule
		Weighted dyn. & \pathref{P2-A01},\allowbreak \pathref{P2-A02} & \texttt{weightedMeasure}, \nolinkurl{total_measure_decr} \\
		Decision      & \pathref{P2-A03},\allowbreak \pathref{P2-A04} & \nolinkurl{reachable_triples_finite}                     \\
		Protocol      & \pathref{P2-A05},\allowbreak \pathref{P2-A06} & \nolinkurl{crash_tolerance_iff}                          \\
...
\begin{table}[H]
	\centering
	\footnotesize
	\begin{tabularx}{\columnwidth}{@{}L{0.21\columnwidth}L{0.39\columnwidth}L{0.31\columnwidth}@{}}
		\toprule
		\thead{Result}   & \thead{Modules}                               & \thead{Anchors}                      \\
		\midrule
		Quant.\ dynamics & \pathref{P2-A01},\allowbreak \pathref{P2-A02} & \texttt{weightedMeasure}             \\
		Decidability     & \pathref{P2-A03},\allowbreak \pathref{P2-A04} & \nolinkurl{reachable_triples_finite} \\
		Crash/branch     & \pathref{P2-A05},\allowbreak \pathref{P2-A06} & \nolinkurl{crash_tolerance_iff}      \\
		Byzantine        & \pathref{P2-A09},\allowbreak \pathref{P2-A08} & \nolinkurl{byzantineSafety_exact}    \\
		\bottomrule
	\end{tabularx}
...
\begin{table}[H]
	...
	\begin{tabularx}{\columnwidth}{@{}L{0.2\columnwidth}L{0.75\columnwidth}@{}}
		...
		\texttt{P2-A02} & \nolinkurl{Lyapunov.lean}          \\
		\texttt{P2-A03} & \nolinkurl{AsyncSubtyping/*.lean}  \\
		\texttt{P2-A04} & \nolinkurl{BisimDecidable/*.lean}  \\
...
\begin{table}[H]
	...
	\begin{tabularx}{\columnwidth}{@{}L{0.22\columnwidth}L{0.1\columnwidth}L{0.32\columnwidth}L{0.3\columnwidth}@{}}
		...
		\midrule
		Theorem 1     & \S4          & Assump.~\ref{assump:p2-quantitative} & \pathref{P2-A01}      \\
		Theorem 2     & \S5          & Assump.~\ref{assump:p2-regular}      & \pathref{P2-A03}      \\
		Theorem 3     & \S6          & Assump.~\ref{assump:p2-crash}        & \pathref{P2-A05}      \\
		Theorem 4     & \S6          & Assump.~\ref{assump:p2-byzantine}    & \pathref{P2-A07}      \\
		Cor.\ 4.1     & \S6          & Thm 4 + dropped                      & Section 6             \\
		Cor.\ 1       & \S7          & Thm 1 premises                       & derived in \S7        \\
		Cor.\ 2       & \S7          & Thm 1 + sched.                       & derived in \S7        \\
		Cor.\ 3       & \S7          & regular + thresh.                    & \pathref{P2-A06}      \\
		Prop.\ 2      & \S6          & pack + adhere                        & \pathref{P2-A08}      \\
		Prop.\ 1      & \S9          & claim-map coverage + App.\ F checks  & Section 9, Appendix F \\
		\bottomrule
	\end{tabularx}
