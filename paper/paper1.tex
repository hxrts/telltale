...
Core theorem anchors and their source locations are listed in Table~\ref{tab:p1-anchor-registry} (Appendix~\ref{app:p1-anchor-registry}).
...
\begin{table}[H]
	\centering
	\footnotesize
	\begin{tabularx}{\columnwidth}{@{}L{0.42\columnwidth}L{0.53\columnwidth}@{}}
		\toprule
		...
		\texttt{EdgeCoherent\_type\_replacement} & \texttt{Protocol/Coherence/\allowbreak}\mbox{\texttt{SubtypeReplacement*.lean}} \\
		...
		\texttt{FIFODelivery\_laws} & \texttt{Protocol/}\mbox{\texttt{DeliveryModel.lean}} \\
		\texttt{CausalDelivery\_laws} & \texttt{Protocol/}\mbox{\texttt{DeliveryModel.lean}} \\
		\texttt{LossyDelivery\_laws} & \texttt{Protocol/}\mbox{\texttt{DeliveryModel.lean}} \\
		...
		\texttt{effectBisim\_implies\_observationalEquivalence} & \texttt{Runtime/Proofs/EffectBisim/}\mbox{\texttt{Bridge.lean}} \\
		\texttt{configEquiv\_iff\_effectBisim\_silent} & \texttt{Runtime/Proofs/EffectBisim/\allowbreak}\mbox{\texttt{ConfigEquivBridge.lean}} \\
		\texttt{ByzIfaceWF} & \texttt{Runtime/Proofs/Adapters/Distributed/\allowbreak}\mbox{\texttt{EnvelopeTheorems.lean}} \\
		\texttt{byzIfaceWF\_iff\_coherent} & \texttt{Runtime/Proofs/Adapters/Distributed/\allowbreak}\mbox{\texttt{EnvelopeTheorems.lean}} \\
...
\begin{center}
	...
	\begin{tabularx}{\columnwidth}{@{}L{0.2\columnwidth}L{0.08\columnwidth}L{0.42\columnwidth}L{0.20\columnwidth}@{}}
		...
		\midrule
			...
			Thm.\ BZ-1     & \S8           & Byzantine interface premises (\ref{assump:p1-byzantine}) & \texttt{ByzIfaceWF}  \\
