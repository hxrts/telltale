...
Here $S(e):=\EdgeShares(e,\mathit{ep})$.
\begin{equation}
	\begin{aligned}
		\mathsf{updated}   & :\ e=u;\\
		\mathsf{shared}    & :\ e\neq u\land S(e);\\
...
Path identifiers used in this table resolve in Appendix~\ref{app:p1-path-registry}.
...
\begin{table}[H]
	...
	\begin{tabularx}{\columnwidth}{@{}L{0.27\columnwidth}L{0.36\columnwidth}L{0.27\columnwidth}@{}}
		...
		\midrule
		Definitions       & \pathref{P1-A01},\allowbreak \pathref{P1-A02} & \texttt{Consume}, \texttt{EdgeCoherent} \\
		Consume kernel    & \pathref{P1-A01}                              & \nolinkurl{Consume_append}              \\
		Three-way split   & \pathref{P1-A03}                              & \nolinkurl{edge_case_split}             \\
		Preservation      & \pathref{P1-A04}                              & \nolinkurl{Coherent_*_preserved}        \\
		Delivery variants & \pathref{P1-A05}                              & \nolinkurl{*Delivery_laws}              \\
...
\subsection{Theorem 2: Session Evolution via \texorpdfstring{\texttt{Consume\_mono}}{Consume_mono}}
...
\begin{itemize}
	...
	\item \pathref{P1-A13}: \texttt{progress\_conditions\_type\_replacement}
\end{itemize}
...
\begin{table}[H]
	...
	\begin{tabularx}{\columnwidth}{@{}L{0.2\columnwidth}L{0.75\columnwidth}@{}}
		...
		\texttt{P1-A02} & \nolinkurl{EdgeCoherence-Core.lean}                                        \\
		\texttt{P1-A03} & \nolinkurl{Unified.lean}                                                   \\
		\texttt{P1-A04} & \nolinkurl{Preservation*.lean}                                             \\
		\texttt{P1-A05} & \nolinkurl{DeliveryModel.lean}                                             \\
		\texttt{P1-A06} & \nolinkurl{SubtypeReplacement*.lean}                                       \\
		\texttt{P1-A07} & \nolinkurl{lean/Protocol/Coherence/Unified.lean}                           \\
		\texttt{P1-A08} & \nolinkurl{lean/Protocol/Coherence/Preservation.lean}                      \\
		\texttt{P1-A09} & \nolinkurl{lean/Protocol/Coherence/PreservationRecv.lean}                  \\
		\texttt{P1-A10} & \nolinkurl{lean/Protocol/Coherence/SelectPreservation.lean}                \\
		\texttt{P1-A11} & \nolinkurl{lean/Protocol/Coherence/Consume.lean}                           \\
		\texttt{P1-A12} & \nolinkurl{lean/Protocol/Coherence/SubtypeReplacementCore.lean}            \\
		\texttt{P1-A13} & \nolinkurl{lean/Protocol/Coherence/SubtypeReplacementLiveness.lean}        \\
		\texttt{P1-A14} & \nolinkurl{lean/Runtime/VM/Runtime/Monitor.lean}                           \\
		\texttt{P1-A15} & \nolinkurl{lean/Runtime/Proofs/VM/BridgeStrengthening.lean}                \\
		\texttt{P1-A16} & \nolinkurl{lean/Runtime/Proofs/EffectBisim/Bridge.lean}                    \\
		\texttt{P1-A17} & \nolinkurl{lean/Runtime/Proofs/EffectBisim/ConfigEquivBridge.lean}         \\
		\texttt{P1-A18} & \nolinkurl{lean/Runtime/Proofs/Adapters/Distributed/EnvelopeTheorems.lean} \\
		\texttt{P1-A19} & \nolinkurl{lean/Runtime/Proofs/TheoremPack/API.lean}                       \\
...
\begin{center}
	...
	\begin{tabularx}{\columnwidth}{@{}L{0.2\columnwidth}L{0.08\columnwidth}L{0.3\columnwidth}L{0.32\columnwidth}@{}}
		...
		\midrule
		Theorem 1      & \S4           & Core model premises (\ref{assump:p1-core})               & \pathref{P1-A04}  \\
		Theorem 2      & \S6           & Replacement compatibility (\ref{assump:p1-replacement})  & \pathref{P1-A20}  \\
		Prop.\ 1       & \S8           & Core model + bridge obligations                          & runtime bridge    \\
		Thm.\ BZ-1     & \S8           & Byzantine interface premises (\ref{assump:p1-byzantine}) & \pathref{P1-A21}  \\
		Cor.\ BZ-1.1   & \S8           & Byzantine interface + witnesses                          & derived           \\
		Prop.\ BZ-1.2  & \S8           & Byzantine interface + gate                               & \pathref{P1-A22}  \\
		\bottomrule
	\end{tabularx}
