...
synchronized via
\texttt{bash scripts/paper\_repro\_rows.sh --sync paper/paper1.tex paper/paper2.tex paper/paper3.tex}.
...
\begin{table}[H]
	...
	\begin{tabularx}{\columnwidth}{@{}L{0.34\columnwidth}L{0.61\columnwidth}@{}}
		...
		Pinned commit & \texttt{557ffa07300ab088}\allowbreak\texttt{005b68516b8c9475}\allowbreak\texttt{f9cc9625} \\
...
\begin{enumerate}
	...
	\item Before camera-ready submission, set DOI in \texttt{paper/artifact\_metadata.env} and run \texttt{just paper-repro-check-strict}.
\end{enumerate}
