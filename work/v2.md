...
The RumpsteakV2 formalization has **28 axioms, 0 sorries** in the inductive codebase and **7 axioms, 2 sorries** in the coinductive codebase (sorries isolated in RoundtripWIP.lean).
...
⚠️  RumpsteakV2.Coinductive.RoundtripWIP - 2 sorries (incomplete proofs)
    - 1 termination sorry (coinductive IH, justified by guardedness)
    - 1 remaining sorry: RoundtripRel_postfix
```
